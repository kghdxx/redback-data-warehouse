...
# Add this snippet to check the environment variables
...
minio_client = Minio(
    "10.137.0.149:9000",
    access_key= "oMRermz5wLf474preMdK", #os.getenv('AWS_ACCESS_KEY_ID'), #"oMRermz5wLf474preMdK",
    secret_key= "kZ0MyCwVdTu8r2O9SV7wbyZ3tGjJEd0jjDeO5rbn", #os.getenv('AWS_SECRET_ACCESS_KEY'), #kZ0MyCwVdTu8r2O9SV7wbyZ3tGjJEd0jjDeO5rbn 
    secure=False
)
